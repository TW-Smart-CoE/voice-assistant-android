...
android {
    ...
    defaultConfig {
        ...
        addBuildConfigFieldFromProperties(localProperties, "VOLCENGINE_STREAM_SPEECH_SYNTHESIS_CLUSTER_ID")
...
dependencies {
    ...
    // Exclude old kotlin-android-extensions-runtime to avoid conflict with kotlin-parcelize
    configurations.all {
